...
sigma_IE_list = [0*sigma_IE, 10*sigma_IE, 20*sigma_IE, 30*sigma_IE, 40*sigma_IE, 50*sigma_IE]
...
for num in range(repeat_num):
    for sigma_n in range(len(sigma_IE_list)):
        sigma_IE = sigma_IE_list[sigma_n]
        ...
        np.save(r'./data/' + 'sigma_IE'+ str(num) + str(sigma_n) + 'eig.npy', eigs)