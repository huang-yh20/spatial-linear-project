...
sigma_II_list = [0*sigma_II, 0.4*sigma_II, 0.8*sigma_II, 1.2*sigma_II, 1.6*sigma_II, 2*sigma_II]
...
for num in range(repeat_num):
    for sigma_n in range(len(sigma_II_list)):
        sigma_II = sigma_II_list[sigma_n]
        ...
        np.save(r'./data/' + 'sigma_II'+ str(num) + str(sigma_n) + 'eig.npy', eigs)
