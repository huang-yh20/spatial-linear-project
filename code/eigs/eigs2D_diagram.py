...
for plot_n in trange(len(file_name_new_list)):
    plot_eigs2D_diagram(file_name_new_list[plot_n], changed_params_list[plot_n], changed_params_latex_list[plot_n], generate_func_list[plot_n])
