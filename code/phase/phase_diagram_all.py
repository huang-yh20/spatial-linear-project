...
if trial == 0:
    ...
    plot_phase_diagram("d_II_g_bar_EE", changed_params, changed_params_latex, generate_params_phase_d_II_g_bar_EE, p_simul)
if trial == 1:
    changed_params = ['g_bar_EE', 'g_bar_II']
    changed_params_latex = [r'$\bar{g}_{E}$', r'$\bar{g}_{I}$']
    p_simul = Simul_Params(T = 100, t_step=100, record_step=10, activation_func=['tanh','linear'])
    plot_phase_diagram("g_bar_E_I_0", changed_params, changed_params_latex, generate_params_phase_g_bar_E_I_0, p_simul)
if trial == 2:
    changed_params = ['g_bar_EE', 'g_bar_II']
    changed_params_latex = [r'$\bar{g}_{E}$', r'$\bar{g}_{I}$']
    p_simul = Simul_Params(T = 100, t_step=100, record_step=10, activation_func=['tanh','linear'])
...
if trial == 4:
    ...
    p_simul = Simul_Params(T = 100, t_step=100, record_step=10, activation_func=['tanh','linear'])
    plot_phase_diagram("g_bar_IE_d_II", changed_params, changed_params_latex, generate_params_phase_g_bar_IE_d_II, p_simul)
