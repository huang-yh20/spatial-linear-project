...
changed_params_latex = [r'$\sigma$', r'$d_{II}$']
p_simul = Simul_Params(T = 2000, t_step=5, record_step=10, activation_func=['tanh','tanh_high'], external_input="noise",tau_m=20.0)
marker_list = [(15,9)]
plot_phase_diagram_new("g_d_II_L_chaos", changed_params, changed_params_latex, generate_params_phase_g_d_II_L_chaos, p_simul, repeat_num=1, marker_list=marker_list)
