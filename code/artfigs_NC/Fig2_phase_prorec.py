...
for repeat_trial in range(0, repeat_num):
    ...
    # p_simul = Simul_Params(T = 2000, t_step=5, record_step=10, activation_func=['tanh','tanh_high'], external_input="noise",tau_m=20.0)
    # p_net = generate_params_phase_alpha_d_II_L_chaos(trial1, trial2, trial_num)
    # record_x = dyn_simul(p_net, p_simul, dim=2, homo_fix_point=False)
    # np.save(r"./data/artfigs_NC_"+'alpha_d_II_L_chaos'+'_'+str(trial1)+'_'+str(trial2)+'_'+str(repeat_trial)+r'.npy',record_x)
    ...
    # p_simul = Simul_Params(T = 2000, t_step=5, record_step=10, activation_func=['tanh','tanh_high'], external_input="noise",tau_m=20.0)
    # p_net = generate_params_phase_wspa_g_bar_IE_g_bar_EE_L(trial1, trial2, trial_num)
    # record_x = dyn_simul(p_net, p_simul, dim=2, homo_fix_point=False)
    # np.save(r"./data/artfigs_NC_"+'wspa_g_bar_IE_g_bar_EE'+'_'+str(trial1)+'_'+str(trial2)+'_'+str(repeat_trial)+r'.npy',record_x)

    # p_simul = Simul_Params(T = 2000, t_step=5, record_step=10, activation_func=['tanh','tanh_high'], external_input="noise",tau_m=20.0)
    # p_net = generate_params_phase_wospa_g_bar_IE_g_bar_EE_L(trial1, trial2, trial_num)
    # record_x = dyn_simul(p_net, p_simul, dim=2, homo_fix_point=False)
    # np.save(r"./data/artfigs_NC_"+'wospa_g_bar_IE_g_bar_EE'+'_'+str(trial1)+'_'+str(trial2)+'_'+str(repeat_trial)+r'.npy',record_x)
