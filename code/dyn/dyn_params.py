...
def generate_params_dyn_global_new(trial:int):
    rescale = 400
    N_E, N_I = 22500, 5625
    conn_NEE, conn_NIE, conn_NEI, conn_NII = 200, 50, 200, 50
    J_EE, J_IE, J_EI, J_II = 4/rescale, 4/rescale, -8/rescale, -8/rescale
...
def generate_params_dyn_bump_new(trial:int):
    rescale = 375
    N_E, N_I = 22500, 5625
    conn_NEE, conn_NIE, conn_NEI, conn_NII = 200, 50, 200, 50
    J_EE, J_IE, J_EI, J_II = 4/rescale, 4/rescale, -18/rescale, -18/rescale
    sigma_EE, sigma_IE, sigma_EI, sigma_II = 4/rescale, 4/rescale, 10/rescale, 10/rescale
...
def generate_params_dyn_osc_new(trial:int):
    rescale = 400
    N_E, N_I = 22500, 5625
    conn_NEE, conn_NIE, conn_NEI, conn_NII = 200, 50, 200, 50
    J_EE, J_IE, J_EI, J_II = 4/rescale, 4/rescale, -8/rescale, 0/rescale
...
def generate_params_dyn_wave_new(trial:int):
    rescale = 207.5
    N_E, N_I = 22500, 5625
    conn_NEE, conn_NIE, conn_NEI, conn_NII = 200, 50, 200, 50
    J_EE, J_IE, J_EI, J_II = 5/rescale, 9/rescale, -9/rescale, -14/rescale
    sigma_EE, sigma_IE, sigma_EI, sigma_II = 3/rescale, 6/rescale, 6/rescale, 8/rescale
    d_EE, d_IE, d_EI, d_II = 0.05, 0.05, 0.05, 0.08
...
def generate_params_dyn_chaos_new(trial:int):
    #chaos
    rescale = 800
    sigma_rescale = 5.5
    N_E, N_I = 22500, 5625
